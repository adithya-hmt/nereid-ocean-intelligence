...
const result = (wmo: string, cycle: number, source_profile_index: number) => ({
  ...
  data: [{ wmo, cycle, direction: 'A' as const, source_profile_index, vertical_sampling_scheme: 'primary' }], chart_spec: [], provenance: [], qc_summary: { retained: 1, rejected: 0 }, methods: [], assumptions: [], warnings: [],
})
