...
type Props = { result: ResultEnvelope; selections: Selection[]; onSelectionChange: (selections: Selection[]) => void; readOnly?: boolean }
...
export function ScientificReceipt({ result, selections, onSelectionChange, readOnly = false }: Props) {
